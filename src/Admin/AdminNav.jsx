'use client'
import admin_profile from "./assets/Admin.avif"
import {
    Box,
    Flex,
    Text,
        ...
        <Box w="100%" >
            <Flex
                ...
                <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }}>
                    <Image w={{ base: "50px", md: "80px", lg: "80px" }} h={{ base: "50px", md: "80px", lg: "80px" }} borderRadius={"50%"} src={"https://bit.ly/sage-adebayo"} alt="" />
